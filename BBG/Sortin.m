function [  ] = Sortin( LaKu,LoKu,LaTop,LaBottom,LoRight,LoLeft,bnum,day,month,year,orbit,IncAngleKu,sigmaKu,preciprateKu,secofdayKu)
    sizeKu=size(LaKu);
    firstTime=true;
    dirn = strcat(bnum{1},'\d',day,'m',month,'y',year,orbit);
     for ii=1:sizeKu(1)
        for jj=1:sizeKu(2)
